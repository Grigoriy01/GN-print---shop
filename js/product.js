...
document.addEventListener("submit", (e) => {
  if (e.target.id === "checkoutForm") {
    ...
    panel.querySelector(".pay-btn").addEventListener("click", () => {
      ...
      fetch("https://proxy-printshop.m9258923028.workers.dev/?url=https://script.google.com/macros/s/AKfycbzZPcrh2CWgxHWQHFqgWLONZ2EoZk5koaOJwv_MkQWKDdGavi6aCKcaPGlScYfxy4xLZQ/exec", {
        method: "POST",
        headers: {
